...
----------------------------------------------------------------------------------------------------
	...
	['water'] = { -- Carbonized syrup is good for the soul
			...
			client = {
					status = { thirst = 500000, stress = -10000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
	...
	['coffee_black'] = { -- Carbonized syrup is good for the soul
			...
			client = {
					status = { thirst = 380000, drunk = -50000, stress = 30000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
	...
	['coffee_mocha'] = { -- Carbonized syrup is good for the soul
			...
			client = {
					status = { thirst = 380000, drunk = -30000, stress = 10000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
					prop = { model = 'ng_proc_coffee_01a', 
					pos = vec3(0.008, 0.0, -0.05), rot = vec3(0.0, 0.0, -40.0) },
					usetime = 7500,
	...
	['coffee_cpcno'] = { -- Carbonized syrup is good for the soul
			...
			client = {
					status = { thirst = 380000, drunk = -40000, stress = 20000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
					prop = { model = 'ng_proc_coffee_01a', 
					pos = vec3(0.008, 0.0, -0.05), rot = vec3(0.0, 0.0, -40.0) },
					usetime = 7500,
	...
	['coffee_amrcno'] = { -- Carbonized syrup is good for the soul
			...
			client = {
					status = { thirst = 380000, drunk = -45000, stress = 20000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
					prop = { model = 'ng_proc_coffee_01a', 
					pos = vec3(0.008, 0.0, -0.05), rot = vec3(0.0, 0.0, -40.0) },
					usetime = 7500,
	...
	['ejunk'] = { -- Drinking too much of this wont kill you. I think.
			...
			client = {
					status = { thirst = 300000, stress = -150000 },
					anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
...
----------------------------------------------------------------------------------------------------
  ...
  ['crutch'] = {
	...
	['cigarette'] = {
		label = 'Cigarette',
		weight = 50,
		description = "This probably isn't good for you, but oh well",
		close = true,
		stack = true,
		client = {
	...
	['cigs_debonaireblue'] = {
			label = 'Debonaire Blue Cigarettes',
			weight = 200,
			stack = true,
			close = true,
			client = {
	...
	['cigs_debonairegreen'] = {
			label = 'Debonaire Green Cigarettes',
			weight = 200,
			stack = true,
			close = true,
			client = {
